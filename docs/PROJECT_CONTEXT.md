...
The heatmap keeps its full weekly table on desktop. At widths up to 760px it shows a seven-day picker with daily urgency indicators and a two-column list of colour-coded hourly cards for the chosen day. Cards label shortages/spare capacity explicitly without hover, keep overnight hours under their business day with a next-day label, and show an empty state for days without demand. Day selection does not change the app's global selected week or submit the availability form.
