...
namespace Roaster_Generator.Data.Migrations
{
    ...
    [Migration("20260917142359_AddCompanyVehicleCapacity")]
    partial class AddCompanyVehicleCapacity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.DemandPlan", b =>
                {
                    ...
                    b.Property<decimal>("DeliveriesPerDriverHour")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 4)
                    ...
                    b.Property<decimal>("PizzasPerInsideHour")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 4)
                        .HasColumnType("numeric(12,4)")
                        .HasDefaultValue(20m)
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.DemandValue", b =>
                {
                    ...
                    b.Property<int?>("InsideDemand")
                        .HasColumnType("integer")
                        .HasColumnName("inside_demand");

                    b.Property<decimal?>("Pizzas")
                        .HasColumnType("numeric(10,2)")
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.DriverProfile", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uuid")
                        .HasColumnName("employee_id");
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.InStoreProfile", b =>
                {
                    ...
                    b.ToTable("instore_profiles", (string)null);
                });

            modelBuilder.Entity("Roaster_Generator.Entities.ManagerProfile", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uuid")
                        .HasColumnName("employee_id");
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.RosterGenerationSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<int>("CompanyCars")
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("company_cars");

                    b.Property<int>("CompanyEBikes")
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("company_ebikes");

                    b.Property<int>("CompanyMopeds")
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("company_mopeds");
                    ...
                    b.Property<int>("ExactSearchNodeLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("HistoryShiftLengthWeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(100)
                        .HasColumnName("history_shift_length_weight");
                    ...
                    b.Property<int>("MaxSolveSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(20)
                        .HasColumnName("max_solve_seconds");

                    b.Property<int>("MinimumRestHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(8)
                        .HasColumnName("minimum_rest_hours");

                    b.Property<decimal>("MutationRate")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("PreferredRestHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(12)
                    ...
                    b.ToTable("roster_generation_settings", (string)null);
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.RosterPlan", b =>
                {
                    ...
                    b.Property<string>("RosterKind")
                        ...
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasDefaultValue("drivers")
                        .HasColumnName("roster_kind");
                    ...
                    b.HasIndex("WeekStart", "RosterKind")
                        .IsUnique();
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.SickLeaveRequest", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AttachmentDeletedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("attachment_deleted_at_utc");
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.InStoreProfile", b =>
                {
                    b.HasOne("Roaster_Generator.Entities.Employee", "Employee")
                        .WithOne("InStoreProfile")
                        .HasForeignKey("Roaster_Generator.Entities.InStoreProfile", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Roaster_Generator.Entities.ManagerProfile", b =>
                {
                    b.HasOne("Roaster_Generator.Entities.Employee", "Employee")
                        ...
                        .HasForeignKey("Roaster_Generator.Entities.ManagerProfile", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
